...
return {
    ...
    start = function(self)
        ...
        self.cmd_button.y = syrup.dimensions.height - self.cmd_button.height - self.cmd_button.border * 2 - self.taskbar_padding
        self.cmd_button.depth = self.depth - 0.1
        self.cmd_button.on_click = function(button)
            self.cmd_button.command = syrup.objects.new("editor/command", button.x - self.taskbar_padding, button.y - button.height - button.border - self.taskbar_padding * 2 - 1)
    ...
    update = function(self)
        self.cmd_button.x = self.taskbar_padding
        self.cmd_button.y = syrup.dimensions.height - self.cmd_button.height - self.cmd_button.border * 2 - self.taskbar_padding
        if self.cmd_button.command then
            self.cmd_button.command.y = self.cmd_button.y - self.cmd_button.height - self.cmd_button.border - self.taskbar_padding * 2 - 1
        end
    ...
    draw_ui = function(self)
        syrup.graphics.draw_rectangle(
            0,
            syrup.dimensions.height - self.cmd_button.height - self.cmd_button.border - self.taskbar_padding * 2 - 2,
            syrup.dimensions.width,
            self.cmd_button.height + self.cmd_button.border * 2 + self.taskbar_padding * 2,
            syrup.ui.primary
        )
        syrup.graphics.draw_rectangle(
            0,
            syrup.dimensions.height - self.cmd_button.height - self.cmd_button.border - self.taskbar_padding * 2 - 1,
            syrup.dimensions.width,
            self.cmd_button.height + self.cmd_button.border * 2 + self.taskbar_padding * 2,
            syrup.ui.white
        )
        syrup.graphics.draw_rectangle(
            0,
            syrup.dimensions.height - self.cmd_button.height - self.cmd_button.border - self.taskbar_padding * 2,
            syrup.dimensions.width,
            self.cmd_button.height + self.cmd_button.border * 2 + self.taskbar_padding * 2,
            syrup.ui.primary
        )
